...
const Schema: z.ZodType<Prisma.ProductsUncheckedUpdateManyWithoutSubstitutedByNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductsUncheckedUpdateManyWithoutSubstitutedByNestedInputObjectSchema =
  Schema;
