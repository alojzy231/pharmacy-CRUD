...
const Schema: z.ZodType<Prisma.ProductUncheckedCreateNestedManyWithoutSubstitutesInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductUncheckedCreateNestedManyWithoutSubstitutesInputObjectSchema =
  Schema;
