...
const Schema: z.ZodType<Prisma.NestedEnumProductCategoryWithAggregatesFilter> =
  z
    .object({
      ...
      not: z
        .union([
          z.lazy(() => ProductCategorySchema),
          z.lazy(
            () => NestedEnumProductCategoryWithAggregatesFilterObjectSchema,
          ),
        ])
        .optional(),
      _count: z.lazy(() => NestedIntFilterObjectSchema).optional(),
      _min: z
        .lazy(() => NestedEnumProductCategoryFilterObjectSchema)
        .optional(),
      _max: z
        .lazy(() => NestedEnumProductCategoryFilterObjectSchema)
        .optional(),
...
export const NestedEnumProductCategoryWithAggregatesFilterObjectSchema = Schema;
