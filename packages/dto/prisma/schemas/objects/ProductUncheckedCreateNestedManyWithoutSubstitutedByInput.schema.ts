...
const Schema: z.ZodType<Prisma.ProductUncheckedCreateNestedManyWithoutSubstitutedByInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductUncheckedCreateNestedManyWithoutSubstitutedByInputObjectSchema =
  Schema;
