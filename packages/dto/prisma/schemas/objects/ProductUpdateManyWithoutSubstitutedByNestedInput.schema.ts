...
const Schema: z.ZodType<Prisma.ProductUpdateManyWithoutSubstitutedByNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductUpdateManyWithoutSubstitutedByNestedInputObjectSchema =
  Schema;
