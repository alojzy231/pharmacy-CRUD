...
const Schema: z.ZodType<Prisma.ProductsUncheckedCreateNestedManyWithoutSubstitutedByInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductsUncheckedCreateNestedManyWithoutSubstitutedByInputObjectSchema =
  Schema;
