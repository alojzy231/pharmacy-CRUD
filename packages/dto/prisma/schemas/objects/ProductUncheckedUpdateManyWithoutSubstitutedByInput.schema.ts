...
const Schema: z.ZodType<Prisma.ProductUncheckedUpdateManyWithoutSubstitutedByInput> =
  z
    .object({
      id: z
        .union([
...
export const ProductUncheckedUpdateManyWithoutSubstitutedByInputObjectSchema =
  Schema;
