...
const Schema: z.ZodType<Prisma.ProductUncheckedUpdateWithoutSubstitutesInput> =
  z
    .object({
      id: z
        .union([
...
export const ProductUncheckedUpdateWithoutSubstitutesInputObjectSchema = Schema;
