...
const Schema: z.ZodType<Prisma.ProductsUncheckedUpdateWithoutSubstitutedByInput> =
  z
    .object({
      id: z
        .union([
...
export const ProductsUncheckedUpdateWithoutSubstitutedByInputObjectSchema =
  Schema;
